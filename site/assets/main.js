...
(function() {
				...
				sections = {
					'done': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#done' });
								},
							],
						},
					},
					'intro-playbook': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#intro-playbook' });
								},
							],
						},
					},
					'intro-playbook-1': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#intro-playbook-1' });
								},
							],
						},
					},
					'intro-playbook-2': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#intro-playbook-2' });
								},
							],
						},
					},
					'intro-playbook-3': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#intro-playbook-3' });
								},
							],
						},
					},
					'intro-playbook-4': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#intro-playbook-4' });
								},
							],
						},
					},
					'intro-near-hispano': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#intro-near-hispano' });
								},
							],
						},
					},
					'deep-dive-near-hispano': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#deep-dive-near-hispano' });
								},
							],
						},
					},
					'deep-dive-near-hispano-1': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#deep-dive-near-hispano-1' });
								},
							],
						},
					},
					'deep-dive-near-hispano-2': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#deep-dive-near-hispano-2' });
								},
							],
						},
					},
					'deep-dive-near-hispano-3': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#deep-dive-near-hispano-3' });
								},
							],
						},
					},
					'deep-dive-near-hispano-4': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#deep-dive-near-hispano-4' });
								},
							],
						},
					},
					'deep-dive-near-hispano-5': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#deep-dive-near-hispano-5' });
								},
							],
						},
					},
					'best-practices': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices' });
								},
							],
						},
					},
					'best-practices-1': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-1' });
								},
							],
						},
					},
					'best-practices-2': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-2' });
								},
							],
						},
					},
					'best-practices-3': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-3' });
								},
							],
						},
					},
					'best-practices-4': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-4' });
								},
							],
						},
					},
					'best-practices-5': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-5' });
								},
							],
						},
					},
					'best-practices-6': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-6' });
								},
							],
						},
					},
					'best-practices-7': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-7' });
								},
							],
						},
					},
					'best-practices-8': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-8' });
								},
							],
						},
					},
					'best-practices-9': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#best-practices-9' });
								},
							],
						},
					},
					'appendix1': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#appendix1' });
								},
							],
						},
					},
					'appendix2': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#appendix2' });
								},
							],
						},
					},
					'intro-near-h': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#intro-near-h' });
								},
							],
						},
					},
					'reference-materials': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/#reference-materials' });
								},
							],
						},
					},
					'home': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-RWEVB0WKKD', { 'page_path': '/' });
								},
							],
						},
					},
	...
	// "On Visible" animations.
		...
		onvisible.add('.buttons.style1', { style: 'fade-in', speed: 750, intensity: 1, delay: 500, stagger: 125, replay: false });
		...
		onvisible.add('.gallery.style3', { style: 'zoom-in', speed: 750, intensity: 0, delay: 0, stagger: 125, replay: false });
		...
		onvisible.add('.buttons.style2', { style: 'fade-in', speed: 750, intensity: 1, delay: 500, stagger: 125, replay: false });
		onvisible.add('h1.style9, h2.style9, h3.style9, p.style9', { style: 'fade-in', speed: 1000, intensity: 9, delay: 125, replay: false });
		onvisible.add('h1.style10, h2.style10, h3.style10, p.style10', { style: 'fade-down', speed: 750, intensity: 1, delay: 125, replay: false });
		onvisible.add('.gallery.style4', { style: 'zoom-in', speed: 750, intensity: 0, delay: 0, stagger: 125, replay: false });
